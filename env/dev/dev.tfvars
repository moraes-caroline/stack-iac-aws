...
iam_roles = {
  "app1" = {
    ...
    appconfig_resource_arns      = ["arn:aws:appconfig:sa-east-1:524558748007:application/*/environment/*/configuration/*"]
    secretsmanager_resource_arns = ["arn:aws:secretsmanager:sa-east-1:524558748007:secret:*"]
    kms_resource_arns            = ["*"]
    s3_resource_arns             = ["*"]
    rdspostgresql_resource_arns  = ["arn:aws:rds-db:sa-east-1:524558748007:dbuser:db-RMMZXNO4POHCK4LHXN4PUXE2F4/app"]
  ...
  "app1" = {
    ...
    services = {
      "app1-ser" = {
        ...
        github_repo         = "moraes-caroline/application1"
        github_branch       = "main"
